...
class RollingTeacherScheduleDetailScreen extends StatefulWidget {
  final String teacherName;
  final String teacherNip;
  final String patternName;

  const RollingTeacherScheduleDetailScreen({
    super.key,
  ...
  @override
  State<RollingTeacherScheduleDetailScreen> createState() =>
      _RollingTeacherScheduleDetailScreenState();
}

class _RollingTeacherScheduleDetailScreenState
    extends State<RollingTeacherScheduleDetailScreen> {
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _ScheduleCard(
                  ...
                  onEdit: () => _showScheduleBottomSheet(
                      existingSchedule: schedule, index: index),
  ...
  void _showScheduleBottomSheet(
      {Map<String, String>? existingSchedule, int? index}) {
                  ...
                  children: [
                          ...
                          items: subjects.map((String value) {
                            return DropdownMenuItem<String>(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  fontSize: 14,
                                  color: value == 'Pilih Mapel...'
                                      ? AppColors.textGreyHint
                                      : AppColors.textDark,
                                ),
                              ),
                            );
                            ...
                            onTap: () async {
                              final TimeOfDay? time = await showTimePicker(
                                ...
                                initialTime: TimeOfDay(
                                  hour: int.tryParse(startTime.split(':')[0]) ??
                                      7,
                                  minute:
                                      int.tryParse(startTime.split(':')[1]) ??
                                          30,
                                ),
                              );
                              if (time != null) {
                          ...
                          child: InkWell(
                            onTap: () async {
                              final TimeOfDay? time = await showTimePicker(
                                ...
                                initialTime: TimeOfDay(
                                  hour:
                                      int.tryParse(endTime.split(':')[0]) ?? 9,
                                  minute:
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          if (selectedSubject != 'Pilih Mapel...' &&
              ...
              children: [
                ...
                RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: [
                      const TextSpan(
                          text: 'Apakah Anda yakin ingin menghapus jadwal '),
                      TextSpan(
