...
class ScheduleItem {
  ...
  final String title; // Subject name or Break description
  final String? subtitle; // Teacher name
  final String? room;
...
class FixedStudentScheduleScreen extends StatefulWidget {
  final String className;

  const FixedStudentScheduleScreen({
    super.key,
    required this.className,
  });

  @override
  State<FixedStudentScheduleScreen> createState() => _FixedStudentScheduleScreenState();
}

class _FixedStudentScheduleScreenState extends State<FixedStudentScheduleScreen> {
  ...
  void _showDeleteDialog(ScheduleItem schedule, int index) {
    showDialog(
      context: context,
      builder: (context) {
        return Dialog(
  ...
  void _showScheduleBottomSheet({ScheduleItem? existingSchedule, int? index}) {
